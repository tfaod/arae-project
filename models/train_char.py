...
from models2 import CharSeq2Seq2Decoder
...
args = parser.parse_args(['--data_path', 'data_fr'])#Set datapath heree!!!
...
autoencoder = CharSeq2Seq2Decoder(emsize=args.emsize, nhidden=args.nhidden, ntokens=ntokens, vocab=vocabdict, nlayers=args.nlayers, noise_r=args.noise_r, hidden_init=args.hidden_init, dropout=args.dropout, gpu=args.cuda)
