...
parser.add_argument('--outf', type=str, default="_output_glove_trainable",
...
optimizer_ae = optim.SGD(filter(lambda p: p.requires_grad, autoencoder.parameters()), lr=args.lr_ae)
