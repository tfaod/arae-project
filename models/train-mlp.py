...
from models3 import Seq2Seq2Decoder, Seq2Seq, MLP_D, MLP_G, MLP_Classify
import shutil
import pdb
...
args.outf = output_file_name(args.data_path, args.outf, "mlp")
...
gan_disc = MLP_D(ninput=args.nhidden, noutput=1, layers=args.arch_d, activation="lrelu")
